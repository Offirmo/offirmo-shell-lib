...
OSL_SSPEC_string_should_eq "/A/B/C" "$(OSL_FILE_realpath "/A/B/C")"
OSL_SSPEC_string_should_eq "`pwd`/A" "$(OSL_FILE_realpath "A")"
OSL_SSPEC_string_should_eq "`pwd`/A/B/C" "$(OSL_FILE_realpath "A/B/C")"
...
echo "test OSL_FILE_shorten_git_repo_dir"

OSL_SSPEC_string_should_eq "Offirmo/offirmo-shell-lib" "$(OSL_FILE_shorten_git_repo_dir "git@github.com:Offirmo/offirmo-shell-lib.git")"
OSL_SSPEC_string_should_eq "Offirmo/offirmo-shell-lib" "$(OSL_FILE_shorten_git_repo_dir "ssh://git@github.com:Offirmo/offirmo-shell-lib.git/")"
OSL_SSPEC_string_should_eq "Offirmo/offirmo-shell-lib" "$(OSL_FILE_shorten_git_repo_dir "https://github.com/Offirmo/offirmo-shell-lib.git")"
OSL_SSPEC_string_should_eq "Offirmo/offirmo-shell-lib" "$(OSL_FILE_shorten_git_repo_dir "https://github.com/Offirmo/offirmo-shell-lib.git/")"


echo "test OSL_FILE_extract_git_repo_dir"

OSL_SSPEC_string_should_eq "offirmo-shell-lib" "$(OSL_FILE_extract_git_repo_dir "git@github.com:Offirmo/offirmo-shell-lib.git")"
OSL_SSPEC_string_should_eq "offirmo-shell-lib" "$(OSL_FILE_extract_git_repo_dir "ssh://git@github.com:Offirmo/offirmo-shell-lib.git/")"
OSL_SSPEC_string_should_eq "offirmo-shell-lib" "$(OSL_FILE_extract_git_repo_dir "https://github.com/Offirmo/offirmo-shell-lib.git")"
OSL_SSPEC_string_should_eq "offirmo-shell-lib" "$(OSL_FILE_extract_git_repo_dir "https://github.com/Offirmo/offirmo-shell-lib.git/")"
